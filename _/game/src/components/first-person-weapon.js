...
AFRAME.registerComponent("first-person-weapon", {
  schema: {
    ...
    weaponScale: { type: "vec3", default: "0.1 0.1 0.1" },
    weaponPosition: { type: "vec3", default: "0.3 -0.2 -0.5" },
    weaponRotation: { type: "vec3", default: "0 0 0" },
    muzzleOffset: { type: "vec3", default: "0.8 0.1 0" }, // Position relative to weapon where bullets spawn
